...
function PodcastArticle() {
  ...
  const {  getPodcast, data } = useGetPodcast(id);
  useEffect(() => {
    getPodcast();
  }, []);
  useEffect(() => {
      ...
      <div className="xl:w-[90%] w-[100vw] m-auto px-4 md:px-6 font-jakarta">
        <section className="mt-[20px] lg:mt-[50px] w-full flex justify-around gap-x-10 items-start ">
          <div className="flex-1 ">
            ...
            <p className=" text-base text-left ">{podcastData?.description}</p>
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: podcastData?.article || "" }}
            />
          ...
          <h1 className="text-zinc-900 text-[32px] font-extrabold font-jakarta leading-[110%]">
                 ...
                 <div className="flex justify-start items-center  flex-wrap my-8 gap-2 ">
                    <div className="flex justify-center gap-x-2 items-center border-2 px-2 py-1 rounded-[0.4rem] w-fit   ">
                        <img className="w-8 h-8 rounded-xl" src={spotify} alt="Spotify" />
                        <p className="text-zinc-900 text-lg font-semibold font-jakarta leading-[18px]">Spotify</p>
                    </div>
                    <div className="flex justify-center gap-x-2 items-center border-2 px-2 py-1 rounded-[0.4rem]  w-fit ">
                        <img className="w-8 h-8 rounded-xl" src={applePodcast} alt="Spotify" />
                        <p className="text-zinc-900 text-lg font-semibold font-jakarta leading-[18px]">Apple Podcasts</p>
                    </div>
                    <div className="flex justify-center gap-x-2 items-center border-2 px-2 py-1 rounded-[0.4rem]  w-fit ">
                        <img className="w-8 h-8 rounded-xl" src={podbeat} alt="Spotify" />
                        <p className="text-zinc-900 text-lg font-semibold font-jakarta leading-[18px]">Podbeat</p>
                    </div>
                 </div>
            <PodcastForm/>
          </div>
